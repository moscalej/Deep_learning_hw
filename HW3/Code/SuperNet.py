...
def Start_block(input):
    ...
    conv1 = Activation('relu')(Conv2D(20, (3, 3), strides=(2, 2),
...
pull_1 = smart_bottleneck(conv0, 32, ratio=7, k_size=(3, 3))
super_2 = mul_fire(pull_1, res=pull_1, squeeze=5, expand=10)
pull_2 = smart_bottleneck(super_2, 42, ratio=5)
super_3 = mul_fire(pull_2, res=pull_2, squeeze=7, expand=12)
pull_3 = MaxPool2D()(super_3)
# pull_3=smart_bottleneck(super_3,80,ratio=7,k_size=(3,3))


FL1 = Dropout(0.4)(LeakyReLU()(Dense(64, kernel_regularizer=keras.regularizers.l2(weight_decay))(Flatten()(pull_3))))
