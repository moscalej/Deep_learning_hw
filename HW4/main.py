...
a = ReviewGenerator(v_size=5_000, review_len=100,l_s_t_m_state_size=512)
...
a.model.fit([Data, sentiment], L_rnn, 128, 100, validation_split=0.2,verbose=2,callbacks=[tbCallBack],initial_epoch=50)
