...
if "Zach" in os.environ.get('USERNAME'):
    ...
    tf_log_path = r'C:\Users\amoscoso\Documents\Technion\deeplearning\Deep_learning_hw\FinalProject\TB\vgg19_bm_t4'
    check_point_path = \
        r'C:\Users\amoscoso\Documents\Technion\deeplearning\Deep_learning_hw\FinalProject\check_point\vgg19_bm_t4\{epoch:02d}-{loss:.4f}.h5'
...
generator = t_4_dataset.generate_batch(64)

model.fit_generator(generator, steps_per_epoch=1300 // 16, epochs=100,
