...
l =evaluate(r'C:\Users\amoscoso\Documents\Technion\deeplearning\Deep_learning_hw\Final_Project\data\example\\')
print (l)
#
# # %%
# SHAPE = 64
...
# #%%
# model.fit(x_center, trainY, batch_size=512, epochs=30, verbose=2, validation_split=0.2)
#
# # %%
